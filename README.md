...
My thing is finding patterns in messy data, building dashboards that actually tell a story, and lately — **vibe coding**: spinning up projects late at night with good music and a problem worth solving.

I interned at **EY** analysing multi-state renewable energy datasets, built research at **NIT-Tiruchirappalli**, and currently lead **Hawk3ye** — an AI-drone surveying system for wind farms. I also captained the **first all-women autonomous vehicle team** at aBAJA SAEINDIA 2025 to **All India Rank 5**.

I'm at the intersection of **data analytics**, **AI engineering**, and **real-world systems** — and that's exactly where I want to be.
...
- Produced structured reports adopted in client-facing EY deliverables

`Python` &nbsp;`Excel` &nbsp;`Power BI` &nbsp;`Data Modeling`
...
- Terrain mapping, obstacle classification, site scoring
- Coordinating a 5-member cross-functional team
- ~70% reduction in manual survey effort (projected)

`Python` &nbsp;`Computer Vision` &nbsp;`Geospatial Analytics`
...
- Static Systems Lead: BOM, cost reports, design validation
- Radar-based autonomous perception (Stärken Radar)
- **AIR 5** in Business Presentation

`Autonomous Systems` &nbsp;`Radar` &nbsp;`Systems Engineering`
...
- Reproducible report + code on GitHub

`Python` &nbsp;`Pandas` &nbsp;`NumPy` &nbsp;`Data Viz`
...
building   = ["Hawk3ye 🚁", "vibe coding projects 🎧"]
listening  = ["lo-fi while debugging", "anything with a good beat at 11pm"]
open_to    = ["internships", "collabs", "cool AI + data builds"]
```
